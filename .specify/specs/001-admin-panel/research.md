...
| 評価軸 | React Admin 5.x | Refine | 自作（React + Firestore） |
|--------|----------------|--------|-------------------------|
| **開発速度** | ⭐⭐⭐⭐⭐ 最速 | ⭐⭐⭐⭐ 速い | ⭐⭐ 遅い |
| **保守性** | ⭐⭐⭐⭐ 高い | ⭐⭐⭐⭐ 高い | ⭐⭐ 低い（自前で保守） |
...
| カテゴリ | 選定技術 | 理由 |
|---------|---------|------|
| **管理画面フレームワーク** | React Admin 5.x | 開発速度、成熟度、Firebase統合、React 19対応 |
