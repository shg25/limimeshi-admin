...
| limimeshi-admin/docs/adr/ | 管理画面固有の決定 | React Admin選定 |
...
- [ADR-001: Use React Admin for admin panel](./001-use-react-admin-for-admin-panel.md)

## 命名規則

`NNN-short-title.md`形式で命名

**例**: `001-use-react-admin-for-admin-panel.md`
